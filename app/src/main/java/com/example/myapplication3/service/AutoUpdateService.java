...
public class AutoUpdateService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        Intent i = new Intent(this, com.example.myapplication3.service.AutoUpdateService.class);
            ...
            HttpUtil.sendOKHttpRequest(weatherUrl, new Callback() {
                ...
                public void onResponse(Call call, Response response) throws IOException {
                    ...
                    if (weather != null && "ok".equals(weather.status)){
                        SharedPreferences.Editor editor = PreferenceManager.getDefaultSharedPreferences(com.example.myapplication3.service.AutoUpdateService.this).edit();
